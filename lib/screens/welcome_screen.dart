...
import 'package:medicalcare/screens/signup_screen.dart';
import 'package:medicalcare/theme/theme.dart';
import 'package:medicalcare/widgets/custom_scaffold.dart';
import 'package:medicalcare/widgets/welcome_button.dart';
                ...
                child: RichText(
                  ...
                  text: const TextSpan(
                    children: [
                      ...
                      TextSpan(
                        text:
                            '\nEnter details and Be Happy! \nDont take any Stress or Tension' ,
                        style: TextStyle(
                          fontSize: 20,
                          //height: 0,
                        ),
